...
export const computeRealizedPriceImpact = (trade: InterfaceTrade): string => {
  ...
  return trade.priceImpact.subtract(realizedLpFeePercent).multiply(-1).toSignificant(3)
}
...
const getRouteRealizedLPFeePercent = (overallPercent: Percent, pools: Array<Pool | Pair>) => {
